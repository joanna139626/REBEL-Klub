...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220526_rebelklube2978frozrywkae297_f93fa5a0f12f28381050_20220526072404_archive.zip';
	const ARCHIVE_SIZE		 = '48895721';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f93fa5a-26072404';
    const SECONDARY_PACKAGE_HASH = '2c76a3f-26072404';
	const VERSION			 = '1.4.6';
